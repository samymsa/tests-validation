...
namespace LoanApp.Tests.AmortizationScheduleWriter;

public class CsvAmortizationScheduleWriterTests
{
    public static IEnumerable<object[]> Data =>
    [
        [new Mortgage(400000, 4, new FixedInterestRate(0m)), @"Month,Cumulative Payment,Balance
1,100000.00,300000.00
2,200000.00,200000.00
3,300000.00,100000.00
4,400000.00,0.00
"],
        [new Mortgage(240000, 12, new FixedInterestRate(2.5m)), @"Month,Cumulative Payment,Balance
...
"],
    ...
    public void WriteAmortizationSchedule_WritesExpectedOutput(ILoan loan, string expected)
    {
        StringBuilder sb = new();
        StringWriter sw = new(sb);
        FixedMonthlyPaymentCalculator calculator = new();
        CsvAmortizationScheduleWriter writer = new(sw, calculator);
        writer.WriteAmortizationSchedule(loan);
